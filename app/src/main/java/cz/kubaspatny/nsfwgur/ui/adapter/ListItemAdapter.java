...
public class ListItemAdapter extends ArrayAdapter<ListItem> {
    ...
    public ListItemAdapter(Context context, List<ListItem> gallery, List<ListItem> comments){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position < mGallery.size()){
            ...
            imageDesc.setText(((ImageDescriptionListItem)mGallery.get(position)).getImageDesctiption());
            ...
            comment.setText(((CommentListItem)mComments.get(position - mGallery.size() - 1)).getCommentText());
